...
import { createBookingPaymentIntent, confirmPayment, getCurrentUser } from "../utils/api";
      ...
      <Card.Body className="p-4">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-3">
            ...
            <h5 className="mb-3">Login Required for Booking</h5>
            <p className="mb-4">Please login to your account to book this package.</p>
          ...
          // Step 1: Booking Details Form (only shown when logged in)
          <Formik
            initialValues={{
